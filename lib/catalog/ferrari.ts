...
const G_V12_GT: Generation[] = [
  ...
  },
  {
    ...
    trims: [
      ...
      { name: '512 TR', years: [1991, 1994] },
      { name: 'F512 M', years: [1994, 1996] },
    ],
  },
  {
  ...
  },
  {
    ...
    trims: [
      { name: '550 Maranello', years: [1996, 2002] },
      { name: '550 Barchetta Pininfarina', years: [2000, 2001] },
    ],
  },
  {
    ...
    trims: [
      ...
      { name: '575 Superamerica', years: [2005, 2006] },
    ],
  },
  {
    ...
    trims: [
      { name: '612 Scaglietti', years: [2004, 2011] },
      { name: '612 Scaglietti HGTC', years: [2007, 2011] },
    ],
  },
  {
    ...
    trims: [
      ...
      { name: '599 GTO', years: [2010, 2012] },
      { name: '599 SA Aperta', years: [2010, 2011] },
    ],
  },
  {
    id: 'ferrari-ff', brand: BRAND, displayName: 'FF',
    modelLine: 'FF', yearStart: 2011, yearEnd: 2016,
    trims: [{ name: 'FF', years: [2011, 2016] }],
  },
  {
    ...
    trims: [
      ...
      { name: 'GTC4Lusso T', years: [2017, 2020] },
    ],
  },
  {
  ...
  },
  {
    ...
    trims: [
      { name: '812 Superfast', years: [2017, 2022] },
      { name: '812 GTS', years: [2019, 2022] },
      { name: '812 Competizione', years: [2021, 2022] },
      { name: '812 Competizione A', years: [2021, 2022] },
      { name: '12Cilindri', years: [2024, ONGOING] },
      { name: '12Cilindri Spider', years: [2024, ONGOING] },
    ],
  },
]
...
const G_MID_V8: Generation[] = [
  ...
  },
  {
    ...
    trims: [
      { name: 'F355 Berlinetta', years: [1994, 1999] },
      { name: 'F355 GTS', years: [1995, 1999] },
      { name: 'F355 Spider', years: [1995, 1999] },
      { name: 'F355 F1', years: [1997, 1999] },
  ...
  },
  {
    ...
    trims: [
      ...
      { name: '360 Spider', years: [2000, 2005] },
      { name: '360 Challenge Stradale', years: [2003, 2004] },
  ...
  },
  {
    ...
    trims: [
      ...
      { name: 'F430 Spider', years: [2005, 2009] },
      { name: 'F430 Scuderia', years: [2007, 2009] },
      { name: 'Scuderia Spider 16M', years: [2008, 2009] },
  ...
  },
  {
    ...
    trims: [
      ...
      { name: '458 Spider', years: [2011, 2015] },
      { name: '458 Speciale', years: [2013, 2015] },
      { name: '458 Speciale A', years: [2014, 2015] },
  ...
  },
  {
    ...
    trims: [
      ...
      { name: '488 Spider', years: [2015, 2019] },
      { name: '488 Pista', years: [2018, 2020] },
      { name: '488 Pista Spider', years: [2018, 2020] },
  ...
  },
  {
    ...
    trims: [
      ...
      { name: 'F8 Spider', years: [2020, 2023] },
    ],
  },
  {
    ...
    trims: [
      { name: '296 GTB', years: [2022, ONGOING] },
      { name: '296 GTS', years: [2023, ONGOING] },
      { name: '296 Speciale', years: [2025, ONGOING] },
      { name: '296 Speciale Aperta', years: [2026, ONGOING] },
...
const G_MODERN_GT: Generation[] = [
  {
    ...
    trims: [
      { name: 'California', years: [2008, 2014] },
      { name: 'California 30', years: [2012, 2014] },
      { name: 'California T', years: [2014, 2017] },
  ...
  },
  {
    ...
    trims: [
      { name: 'Portofino', years: [2018, 2020] },
      { name: 'Portofino M', years: [2020, 2023] },
    ],
  },
  {
    ...
    trims: [
      { name: 'Roma', years: [2020, ONGOING] },
      { name: 'Roma Spider', years: [2023, ONGOING] },
    ],
  },
  {
  ...
  },
  {
    ...
    trims: [{ name: 'Purosangue', years: [2023, ONGOING] }],
  },
]
